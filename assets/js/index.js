...
function view_more() {
  if (document.querySelector(".view_more").innerHTML == "VIEW MORE") {
    document.querySelector(".view_more").innerHTML = "VIEW LESS"
    document.querySelector(".out_more").style.display = "block"
  } else {
    document.querySelector(".view_more").innerHTML = "VIEW MORE"
    document.querySelector(".out_more").style.display = "none"
  }
